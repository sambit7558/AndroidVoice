...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AndroidVoiceLibrary.VoiceService, VoiceLib", VoiceService.class, __md_methods);
	}
	...
	public VoiceService ()
	{
		...
		if (getClass () == VoiceService.class) {
			mono.android.TypeManager.Activate ("AndroidVoiceLibrary.VoiceService, VoiceLib", "", this, new java.lang.Object[] {  });
		}
	}
